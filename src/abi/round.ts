export const roundABI = [
  ...
  },
  {
    ...
    name: "alloSettings",
    outputs: [
      { internalType: "contract AlloSettings", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "applicationIndex", type: "uint256" },
      {
        components: [
          { internalType: "uint256", name: "protocol", type: "uint256" },
          { internalType: "string", name: "pointer", type: "string" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_alloSettings", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "payoutStrategy",
    outputs: [
      { internalType: "contract IPayoutStrategy", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint32", name: "newFeePercentage", type: "uint32" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "newRoundStartTime", type: "uint256" },
      { internalType: "uint256", name: "newRoundEndTime", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes[]", name: "encodedVotes", type: "bytes[]" },
    ],
    name: "vote",
    outputs: [],
    stateMutability: "payable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address payable", name: "recipent", type: "address" },
    ],
    name: "withdraw",
    outputs: [],
    stateMutability: "nonpayable",
